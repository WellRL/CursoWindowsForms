    ...
    public partial class Frm_CadastroCliente_UC : UserControl
    {
        ...
        private void novoToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                C.ValidaClasse();
                C.ValidaComplemento();
               //C.IncluirFichario("C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\Fichario");
        ...
        private void abrirToolStripButton_Click(object sender, EventArgs e)
        {
           if (Txt_Codigo.Text == "")
           ...
           else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    //C = C.BuscarFichario(Txt_Codigo.Text, "C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\CursoWindowsForms\\Fichario");
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    C.ValidaClasse();
                    C.ValidaComplemento();
                    //C.AlterarFichario("C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\CursoWindowsForms\\Fichario");
        ...
        private void ApagatoolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    //C = C.BuscarFichario(Txt_Codigo.Text, "C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\Fichario");
                    C = C.BuscarFicharioDB(Txt_Codigo.Text, "Cliente");
                    if (C == null)
                    {
                        MessageBox.Show("Identificador não encontrado.", "ByteBank", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    ...
                    else
                    {
                        ...
                        {
                            //C.ApagarFichario("C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\Fichario");
        ...
        private void Btn_Busca_Click(object sender, EventArgs e)
        {
            ...
            {
                Cliente.Unit C = new Cliente.Unit();
                //var ListaBusca = C.BuscarFicharioTodos("C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\Fichario");
                ...
                if (FForm.DialogResult == DialogResult.OK)
                {
                    ...
                    //C = C.BuscarFichario(idSelect, "C:\\Users\\well2\\OneDrive\\Área de Trabalho\\Cursos\\CursoWindowsForms\\Fichario");
